        ...
        <>
            <article className="col-span-4">
                ...
                <article className="grid-columns gap-x-4 mt-6 ml-6">
                    ...
                    <div>
                        <button className="bg-black w-80 h-14 rounded-2xl text-white flex justify-center items-center gap-x-1 mt-11"><BsListUl className="text-xl" />More watch options</button>
                    </div>
                    <div>
                        <CastDetail />
                    </div>
